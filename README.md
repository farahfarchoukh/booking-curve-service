...
python evaluation/calibration_tuning.py             # nested-CV search, symmetric widening (~10 min; DESIGN.md §6.11)
python evaluation/asymmetric_calibration_tuning.py  # same search, decoupled P10/P90 widening (~15 min; DESIGN.md §6.11)
